  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
      <motion.div
        ...
        className="bg-white rounded p-8 max-w-md w-full shadow-2xl space-y-6"
      >
        ...
        <div className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  type="text"
                  className="w-full p-3 bg-zinc-50 border border-zinc-100 rounded focus:outline-none focus:ring-2 focus:ring-accent/10 focus:border-accent transition-all"
                  value={name}
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 py-3 rounded border transition-all text-sm font-bold"
